<div>
    ...
    <x-ui.courses.sidebar />

    <main class="py-10 lg:pl-72">
        <div class="px-8 sm:px-6 lg:px-28">
            <!-- Header -->
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center space-x-4">
                    <img src="https://picsum.photos/seed/1/125/70" alt="Cover Image" class="w-[125px] h-[70px] rounded">
                    <div style="width: calc(100% - 126px)">
                        <h1 class="text-2xl font-bold">{{ $latestRevision->title }}</h1>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
            ...
            <section class="mb-6">
                <label class="block text-gray-700">Introduction:</label>
                <textarea class="textarea textarea-bordered w-full" placeholder="+ Tell your learners what the course will be about..."></textarea>
            </section>
            <!-- Main Section -->
            <section class="mb-6">
                <div class="border-dashed border-2 border-gray-300 rounded-lg p-6 text-center">
                    <h2 class="text-lg font-bold">Get started!</h2>
                    <p class="text-gray-500 mb-4">Start creating by dragging and dropping sections, content, or questions here.</p>
                    <button class="btn btn-outline">Watch tutorial</button>
                </div>
            </section>
            <!-- Afterword Section -->
            <section>
                <div>
                    <label class="block text-gray-700">Afterword:</label>
                    <textarea class="textarea textarea-bordered w-full" placeholder="+ Give your learners tips on what to do next..."></textarea>
                </div>
            </section>
        </div>
    </main>
